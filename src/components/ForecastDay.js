    ...
    <>
      <div className="forecast-inner-outer-container">
        <div className="forecast-inner-container">
          ...
          <div><span className="forecast-text"><span>Average Humidity:</span><span>{day.avghumidity}</span></span></div>
        ...
        <div className="forecast-expand">
          <span className="forecast-options-text inline-block" onClick={toggleDisplay}>{displayShowHide}</span>
        </div>
        {!displayExtra ?
          <>
